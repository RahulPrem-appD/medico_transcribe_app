...
class PredefinedSections {
  static final List<ReportSection> all = [
    ...
    ReportSection(id: 'patient_summary', name: 'Patient Summary', description: 'Summary of diagnosis and advice in passive voice', order: 20),
  ];
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 7),
        ],
        format: 'detailed',
        tone: 'formal',
      ),
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 4),
        ],
        format: 'concise',
        tone: 'formal',
      ),
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 14),
        ],
        format: 'detailed',
        tone: 'technical',
      ),
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 8),
        ],
        format: 'detailed',
        tone: 'formal',
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 6),
        ],
    ...
    ReportTemplate(
      ...
      config: ReportTemplateConfig(
        sections: [
          ...
          ReportSection(id: 'patient_summary', name: 'Patient Summary', order: 11),
        ],
        format: 'detailed',
        tone: 'technical',
